...
export default function WhyOurProducts() {
  return (
    <section className="w-full bg-[#FEFFF4] py-20 px-4 sm:px-6 md:px-20 overflow-x-hidden">
      <div className="flex flex-col md:flex-row justify-between items-start gap-12">
        {/* Left Content */}
        <div className="flex-1 p-2 max-w-full md:max-w-[50%]">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={index} className="max-w-full sm:max-w-[400px]">
        ...
        <div className="relative w-full md:w-auto mx-auto">
          ...
          {/* Floating Tag */}
          <div className="absolute left-4 sm:left-24 bottom-16 bg-[#e9eddc] rounded-full px-4 py-2 flex items-center gap-2 shadow-md max-w-[55%]">
            <Image
